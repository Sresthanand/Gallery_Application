(function () {
  ...
  let contentDetailsOverlay = document.querySelector(
  ...
  function handlePlayAlbum() {
    ...
    let id = setInterval(function () {
      if (i < album.slides.length) {
        ...
        playOverlay.querySelector("#text").innerHTML =
          "Showing slide " + (i + 1);
        i++;
  ...
  function handleAddAlbum() {
    ...
    let optionTemplate = allTemplates.content.querySelector(
      "[purpose=new-album]"
    );
  ...
  function handleSlideClick() {
    ...
    let slideInViewTemplate =
      allTemplates.content.querySelector(".slide-in-view");
